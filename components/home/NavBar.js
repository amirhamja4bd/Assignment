        ...
        {/* <div
          ...
          {token ? 
            ...
            <div className="dropdown inline-block relative">
              ...
              <ul className="dropdown-menu hidden absolute bg-gray-100 rounded-lg shadow-md -right-14 text-black pt-1 w-56  flex-col items-center">
                <li className="mb- p-3">
...
//           {token ? 
//             <>
//               <button onClick={logOut} className="bg-primary text-white mt-5 lg:mt-0 w-fit px-5 py-2 rounded-lg hover:bg-primaryHover transition-left ease-in-out duration-300">
//                 Log&nbsp;Out
//               </button>
//             </>
//             :
